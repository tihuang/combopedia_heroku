...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'p4u_combo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='Unnamed', max_length=200)),
            ...
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='creator_combo', to=orm['auth.User'])),
            ('combo_input', self.gf('django.db.models.fields.CharField')(max_length=500)),
        ))
        db.send_create_signal(u'p4u', ['Combo'])

        # Adding model 'Favorites'
        db.create_table(u'p4u_favorites', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_favorite', to=orm['auth.User'])),
            ('combo', self.gf('django.db.models.fields.related.ForeignKey')(related_name='combo_favorite', to=orm['p4u.Combo'])),
        ))
        db.send_create_signal(u'p4u', ['Favorites'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'p4u_favorites')
    ...
    models = {
        ...
        u'p4u.combo': {
            ...
            'combo_input': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
            'combo_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['p4u.ComboType']"}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'creator_combo'", 'to': u"orm['auth.User']"}),
            ...
            'name': ('django.db.models.fields.CharField', [], {'default': "'Unnamed'", 'max_length': '200'})
        },
        u'p4u.combotype': {
        ...
        u'p4u.favorites': {
            ...
            'combo': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'combo_favorite'", 'to': u"orm['p4u.Combo']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'user_favorite'", 'to': u"orm['auth.User']"})
        }
    }
